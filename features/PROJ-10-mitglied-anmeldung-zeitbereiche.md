...
- Anmeldung (Checkbox, An-/Abmelden) für vergangene (archivierte) Activities — macht rückwirkend keinen Sinn; die Übersicht (nur lesen) ist dagegen auch im Archiv erreichbar (Korrektur nach User-Feedback, siehe Decision Log)
...
| **Korrektur:** Das Listen-Icon im Archiv führt jetzt ebenfalls zur Übersicht-Seite (nur lesen) statt zur reinen Info-Detailseite; die Anmeldung-Seite (Checkbox) bleibt für vergangene Activities weiterhin nicht erreichbar | User-Feedback nach dem Übersicht-Namen-Fix; nachträgliches Einsehen, wer bei einer vergangenen Activity zugesagt/teilgenommen hat, ist sinnvoll, ein nachträgliches An-/Abmelden für die Vergangenheit dagegen nicht | 2026-07-15 |
